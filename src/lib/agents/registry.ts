...
export const AGENTS: Record<AgentId, AgentMeta> = {
  ...
  onboarder: {
    ...
    icon: "ClipboardCheck",
    color: "violet",
    promptPath: "prompts/base/onboarder_v2_3.xml",
    defaultPromptVersion: "2.3",
  ...
  portfolio_curator: {
    ...
    icon: "FolderGit2",
    color: "cyan",
    promptPath: "prompts/base/portfoliocurator_v1_3.yml",
    defaultPromptVersion: "1.3",
    persistsTo: "agent_results",
    rateLimitPerMin: 1,
    displayOrder: 110
  ...
  clarifier: {
    ...
    icon: "Sparkles",
    color: "fuchsia",
    promptPath: "prompts/base/clarifier_v1_0.yml",
